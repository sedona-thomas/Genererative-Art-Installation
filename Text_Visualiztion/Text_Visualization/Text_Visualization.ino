...
void loop() {
  ...
  writeLine(EnglishUDHR, 0, 0, 2);
  //writeScrollingLine(EnglishUDHR, 0, 0, 2);
  //writeDoubleScrollingLine(EnglishUDHR, FrenchUDHR, 0, 0, 2);
...
// writeDoubleScrollingLine(): writes two lines of text to the screen and scrolls through the text
void writeDoubleScrollingLine(String str1, String str2, int xPos, int yPos, int size) {
  for (int i = 0; i < str1.length(); i++) {
    resetScreen();
    
    tft.setCursor(xPos - i, yPos, size);
    tft.print(str1);
    
    tft.setCursor(xPos - i, yPos + 10 * size, size);
    tft.print(str2);

    tft.setCursor(155, 125, 1);
    tft.print("Sedona Thomas");
...
void writeScrollingLine(String str, int xPos, int yPos, int size) {
